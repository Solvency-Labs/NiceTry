...
lean_lib NiceTry where
  ...
  roots := #[
    ...
    `NiceTry.Fors.Bridge.YulParser,
    `NiceTry.Fors.Bridge.YulParserTests,
    `NiceTry.Fors.Bridge.ForsYulTokens,
    `NiceTry.Fors.Bridge.YulSourceDecidableEq,
    `NiceTry.Fors.Bridge.ForsYulSource,
    `NiceTry.Fors.Bridge.ForsYulRuntimeParts,
